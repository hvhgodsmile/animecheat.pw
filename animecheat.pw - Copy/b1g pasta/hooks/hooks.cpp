...
namespace hooks {
	void load( ) {
		...
		g_csgo.m_cvar()->FindVar("viewmodel_offset_x")->callbacks.SetSize(0);
		g_csgo.m_cvar()->FindVar("viewmodel_offset_y")->callbacks.SetSize(0);
		g_csgo.m_cvar()->FindVar("viewmodel_offset_z")->callbacks.SetSize(0);
